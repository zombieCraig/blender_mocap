...
bl_info = {
    "name": "Motion Capture Tools (Hacktop)",
    "author": "Benjy Cook - Hacktop Mod",
    "blender": (2, 90, 0),
    "version": (1, 1, 1),
...
class PANEL_PT_MocapPanel(bpy.types.Panel):
            ...
            if performer_obj.data and enduser_obj.data:
                if performer_obj.data.name in bpy.data.armatures and enduser_obj.data.name in bpy.data.armatures:
                    ...
                    for bone in perf.bones:
                        footCol.prop(data=bone, property='foot', text='', icon='POSE_HLT')
...
class PANEL_PT_MocapConstraintsPanel(bpy.types.Panel):
...
class PANEL_PT_ExtraToolsPanel(bpy.types.Panel):
    # Motion capture retargeting panel
...
classes = (
	PANEL_PT_MocapPanel,
	PANEL_PT_MocapConstraintsPanel,
	PANEL_PT_ExtraToolsPanel,
	OBJECT_OT_RetargetButton,
	OBJECT_OT_SaveMappingButton,
	OBJECT_OT_LoadMappingButton,
	OBJECT_OT_SelectMapBoneButton,
	OBJECT_OT_ConvertSamplesButton,
	OBJECT_OT_LooperButton,
	OBJECT_OT_DenoiseButton,
	OBJECT_OT_LimitDOFButton,
	OBJECT_OT_RemoveLimitDOFButton,
	OBJECT_OT_RotateFixArmature,
	OBJECT_OT_ScaleFixArmature,
	MOCAP_OT_AddMocapFix,
	OBJECT_OT_RemoveMocapConstraint,
	OBJECT_OT_BakeMocapConstraints,
	OBJECT_OT_UnbakeMocapConstraints,
	OBJECT_OT_UpdateMocapConstraints,
	OBJECT_OT_GuessHierachyMapping,
	OBJECT_OT_PathEditing,
	OBJECT_OT_AnimationStitchingButton,
	OBJECT_OT_GuessAnimationStitchingButton
)
